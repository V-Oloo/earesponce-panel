...
export class HomeEighteenComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.registrationForm = this.fb.group(
            ...
            {
                validators: [
                    MustMatch("password", "confirm_pass"),
                    MustMatch("email", "verify_email"),
                ],
            }
        );
    ...
    setradio(value) {
        ...
        if (value === "1") {
            ...
            this.registrationForm
                .get("health_care")
                .valueChanges.subscribe((health_care) => {
    ...
    registerUser() {
        ...
        const dob = this.datePipe.transform(
        ...
        const education_level_id = this.registrationForm.value
            .education_level_id;
        const employment_status_id = this.registrationForm.value
        ...
        const sector_category_id = this.registrationForm.value
            .sector_category_id;
        ...
        const partner = this.urlParams.partner;
        ...
        this.service.register(data).subscribe(
            (res) => {
                (this.loading = false), (this.showForms = false);
